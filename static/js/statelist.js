...
function getDistricts(state) {
    return stateList[state].districts;
}

function getStateListHTML() {
    var h = "<option value='' selected disabled>Select State</option>";
    Object.keys(stateList).forEach(function(s) {
        h += "<option value='"+s+"'>"+s+"</option>";
    });
    return h;
}

function getDistrictListHTML(state) {
    var districts = "<option value='' selected disabled>Select District</option>";
    stateList[state].forEach(function(s) {
        districts += "<option value='"+s+"'>"+s+"</option>";
    });
    return districts;
}
